...
if(EXISTS "${GUEST_SYMBOL_TABLE_FILE}")
    ...
    list(APPEND SOURCES "${MKW_RUNTIME_SOURCE_DIR}/cmake/runtime/guest_symbol_table_stub.cpp")
endif()
...
function(mkw_configure_object_target target)
    target_include_directories(${target} PRIVATE
        ...
        "${MKW_RUNTIME_SOURCE_DIR}/src/platform"
...
set(MKW_PPC_SEMANTIC_RUNTIME_SOURCES
    "${MKW_RUNTIME_SOURCE_DIR}/src/cpu/ppc_helpers.cpp"
    "${MKW_RUNTIME_SOURCE_DIR}/src/cpu/fpu_helpers.cpp")
...
target_precompile_headers(mkw_base_shared PRIVATE "${MKW_RUNTIME_SOURCE_DIR}/src/cpu/include/mkw_pch.h")
...
function(mkw_configure_product target)
    ...
    set(MKW_WII_BOOTSTRAP_SOURCE_DIR "${MKW_RUNTIME_SOURCE_DIR}/data/wii")
    ...
    set(MKW_DSP_COEFFICIENT_ROM "${MKW_RUNTIME_SOURCE_DIR}/data/dsp/dsp_coef.bin")
...
target_precompile_headers(WiiCompiled PRIVATE
    "${MKW_RUNTIME_SOURCE_DIR}/src/cpu/include/mkw_pch.h")
if(TARGET mkw_base_sensitive)
    target_sources(WiiCompiled PRIVATE $<TARGET_OBJECTS:mkw_base_sensitive>)
endif()

if(MKW_HAVE_RETRO_REWIND AND EXISTS "${MKW_RETRO_REWIND_PRODUCT_SOURCE}")
